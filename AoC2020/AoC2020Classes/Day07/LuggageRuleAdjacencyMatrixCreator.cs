...
namespace AoC2020Classes.Day07
{
    ...
    {
        private static Dictionary<string, Dictionary<string, int>> CreateEmptyAdjacencyDictionary(
            List<string> allColourList)
        {
        ...
        public static Dictionary<string, Dictionary<string, int>> CreateAdjacencyDictionary(
            List<LuggageRule> luggageRuleList)
        {
