...
namespace AoC2020
{
    public class AoC2020Day02
    {
        ...
        private static readonly List<string> InputList =
            ReadInput.ConvertInputTextToStringList(@"..\..\..\Inputs\Day2InputText.txt", Delimiter);

        private static readonly List<PasswordItem> ConvertedInputList =
            InputList.ConvertAll(x => new PasswordItem(x)).ToList();
